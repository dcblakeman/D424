...
They will execute documentation, unit testing, revision of software applications, and deploy software applications with scripts and containers on a cloud platform.
    ...
    2. How to create a branch and start Development?
       ...
       * IntelliJ method
         ...
         > In IntelliJ, go to the 'Git' button on the top toolbar. Select the new branch option and create a name for the branch. Make sure checkout branch is selected and press the create button to push the new branch to the local repo.
